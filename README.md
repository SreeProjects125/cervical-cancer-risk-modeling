...
This work is for research and educational purposes only, not medical decision-making. The dataset is split into a training set, which the model learns from, and a testing set, which is used to evaluate its performance.
